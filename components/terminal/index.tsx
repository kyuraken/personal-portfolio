          ...
          <TerminalInput
            ...
            onKeyDown={(e: React.KeyboardEvent<HTMLInputElement>) => {
              ...
              switch (commandInput.toLowerCase().trim()) {
                case 'projects':
                  newOutput += `<h4>
                      <a target="__blank" href="https://paperlessbooks.vercel.app/">• Paperless</a>
                  </h4>`;
                  break;
                case 'cd projects':
                ...
                case 'about':
                  newOutput += `<h3>
                    Hello! My name is Jason Hua. I am a computer science student, software engineer, and aspiring technologist with a strong interest in intelligent systems and security. I am currently pursuing a Bachelor of Science in Computer Science at the Georgia Institute of Technology, where my concentrations focus on Cybersecurity & Privacy and Intelligence, with an expected graduation in December 2026.
                    <br/>   
                    Throughout my academic and professional experience, I have worked with a wide range of technologies, including Java, Python, C/C++, JavaScript, TypeScript, React, Node.js, Express, MongoDB, MySQL, Firebase, Docker, and Git. I’ve applied these tools across full-stack web applications, embedded systems, and machine learning projects. While my work spans multiple domains, I am especially comfortable building end-to-end systems—from backend APIs and databases to frontend interfaces—while keeping performance and reliability in mind. Currently, I am continuing to deepen my understanding of data structures, systems programming, machine learning, and AI, while expanding my experience with modern development tools and architectures. I’m particularly interested in the intersection of intelligence, security, and real-world applications.
                    <br/>
                    Outside of software development, I enjoy watching sports (Go Pacers and Colts!!!) spending time hanging out with friends, swimming, and going to the gym. I like staying active and value having balance outside of tech, whether that’s through fitness, competition, or simply enjoying time with people around me.
                    </h3>`;
                  break;
                case 'cd about':
                ...
                case 'socials':
                  newOutput += `<h4>
                    ...
                    <a target="__blank" href="https://github.com/kyuraken">https://github.com/kyuraken</a>
                </h4>`;
                  newOutput += `<h4>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a target="__blank" href="mailto:jasonhua610@gmail.com">jasonhua610@gmail.com</a>
                </h4>`;
                  newOutput += `<h4>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a target="__blank" href="https://www.linkedin.com/in/jasonhua610/">https://www.linkedin.com/in/jasonhua610/</a>
                </h4>`;
                  break;
                default:
